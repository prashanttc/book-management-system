  ...
  return (
    <div>
     ...
     <div className='main flex box w-full  text-white'>
      ...
      <div className='w-[80%] absolute right-0 text-black'> <div className='h-20 flex text-black   text-4xl font-semibold drop-shadow-2xl bg-white items-center justify-center w-full '>book management system</div> <Outlet/>
